#This code is used for testing the influence of the SNR in training phase
import numpy as np
import keras
...
n_channel = 2
R = k / n_channel
print('M:', M, 'emb_k',emb_k, 'k:', k, 'n:', n_channel)
...
plt.grid()
plt.legend(['Autoencoeder_embedding(2,2),emb_k=2','Autoencoeder_onehot(2,2)'],loc = 'upper left')
